import { https, pubsub, logger, region } from "firebase-functions/v1";
 ...
 */
exports.disaportaldataTask = region("asia-northeast1").https.onRequest(
  async (req, res) => {
...
// firestoreを更新する
exports.getDisaportaldata = region("asia-northeast1")
  .pubsub.topic("disaportaldata")
...
exports.disaportaldata = region("asia-northeast1").https.onRequest(
  async (req, res) => {
